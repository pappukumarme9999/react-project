...
import { fetchState } from "../../../../router-config/stateSlice.js";
import { fetchCitiesByState } from "../../../../router-config/citySlice.js";
...
function UpdateBooks() {
  ...
  useEffect(() => {
      ...
      fetchCityByStateId(state_id);
    }, [])

    const fetchCityByStateId = async (state_id) => {
        try {
            let response = await axios.post(apiEndPoint.FETCH_CITY_BY_STATE, { state_id: state_id });
            ...
            <div className="container-fluid py-5 h-100 ">
                <div className="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div className="col-lg-10 col-xl-6" >
                        <div className="border rounded-3  " style={{ boxShadow: "0px 0px 3px #00796B" }}>
                            ...
                            <div className="card-body  p-4 p-md-5">
                                ...
                                <form onSubmit={updateBook} className="px-md-2">
                                    ...
                                    <div className="row form-group mt-2"  >
                                        <div className=" col-md-6">
                                            <select onChange={(event) => fetchCityByStateId(event.target.value)} className="form-control">State
